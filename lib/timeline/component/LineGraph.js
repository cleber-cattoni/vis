...
LineGraph.prototype._calculateGapPositionVIS = function (x) {
  const dateStart = new Date(this.body.range.start)
  const widthTimeline = document.querySelector('.data-region-timeline').offsetWidth;

  let gap = 0;
  if (this.body.range.options.gap < .05) gap = (1 / this.body.range.options.gap) *.0275;
  else if (this.body.range.options.gap < .1) gap = (1 / this.body.range.options.gap) *.16;
  else if (this.body.range.options.gap < .5) gap = (1 / this.body.range.options.gap) *.67;
  else if (this.body.range.options.gap < 1) gap = (1 / this.body.range.options.gap)*1.775;
  else if (this.body.range.options.gap == 1) gap = (this.body.range.options.gap * 2.45);
  else if (this.body.range.options.gap == 2) gap = (this.body.range.options.gap * 2.2);
  else if (this.body.range.options.gap < 5) gap = (this.body.range.options.gap * 1.9);
  else gap = (this.body.range.options.gap * 1.45);
  
  if (widthTimeline > 1000) gap = gap + .5;
  if (widthTimeline > 1000 && gap > 5) gap = gap + 1.5;
  if (this.body.range.options.gap < .05 && widthTimeline < 800) gap = (gap * .0125);
  else if (this.body.range.options.gap < .1 && widthTimeline < 800) gap = (gap * 0.95);
  else if (this.body.range.options.gap < 1 && widthTimeline < 800) gap = (gap * .675);
  if (gap > 10 && widthTimeline < 800) gap = gap * .75
  ...
  valueScreenSmall = (this.body.range.options.gap < 1 && this.body.range.options.gap > .1 && widthTimeline < 800) ? (parseInt(valueDiffWidth / gap)) : valueScreenSmall;  
  ...
  return parseFloat(valueDiffWidth * gap * diffHours) + valueScreenSmall;
}
