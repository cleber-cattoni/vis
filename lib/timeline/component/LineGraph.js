...
LineGraph.prototype._calculateGapPositionVIS = function (x) {
  ...
  let gap = 0;
  if (this.body.range.options.gap < .5) gap = (1 / this.body.range.options.gap) *.67;
  ...
  else if (this.body.range.options.gap < 5) gap = (this.body.range.options.gap * 2.25);
  ...
  valueScreenSmall = (this.body.range.options.gap < 1 && widthTimeline < 800) ? (parseInt(valueDiffWidth / gap)) : valueScreenSmall;
  ...
  if (gap == 12 && widthTimeline < 800) gap = gap * .74
