            ...
            switch (group.options.style) {
              case "line":
                ...
                if (group.group.type === 'line') {
                  DOMutil.attachEvents(line, 'mouseenter', this.options.events.onMouseEnter, groupsData[groupIds[i]]);
                  DOMutil.attachEvents(line, 'mouseout', this.options.events.onMouseOut, groupsData[groupIds[i]]);
                }
              //explicit no break;
              case "point":
              //explicit no break;
              case "points":
                if (group.options.style == "point" || group.options.style == "points" || group.options.drawPoints.enabled == true) {
                  ...
                  DOMutil.attachEvents(points, 'mouseenter', this.options.events.onMouseEnter, groupsData[groupIds[i]]);
                  DOMutil.attachEvents(points, 'mouseout', this.options.events.onMouseOut, groupsData[groupIds[i]]);
                }
                break;
              case "bar":
