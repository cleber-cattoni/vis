  ...
  this._onResize = function() {
    ...
    if (me.dom.root) {
      ...
      if ((me.dom.root.offsetWidth != me.props.lastWidth) ||
        ...
        if (!me.body.reduceRedraw && me.body.eventOnDrawn && me.body.linkedDataId) { // if reduceRedraw, then the event should be fired at redraw componente (ie LineGraph.redraw)
